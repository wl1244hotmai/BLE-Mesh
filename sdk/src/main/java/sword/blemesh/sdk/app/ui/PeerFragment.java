 ...
 *          {@link sword.blemesh.sdk.app.ui.PeerFragment.PeerFragmentListener#onFinished(Exception)}
 *     </li>
 *
 ...
 * {@link sword.blemesh.sdk.app.ui.PeerFragment.PeerFragmentListener}
 */
public class PeerFragment extends BleMeshFragment implements BleMeshService.Callback,
     ...
     * {@link sword.blemesh.sdk.app.ui.PeerFragment.PeerFragmentListener#onDataRequestedForPeer(PeerFragment, Peer)}
     */
    public void sendDataToPeer(byte[] data, Peer recipient) {
        serviceBinder.send(data, recipient);
    }

    /** An available peer was selected from {@link sword.blemesh.sdk.app.adapter.PeerAdapter} */
    ...
    @Override
    public void onDataSent(@NonNull BleMeshService.ServiceBinder binder, byte[] data, @NonNull Peer recipient, Exception exception) {
        if (callback == null) return; // Fragment was detached but not destroyed
